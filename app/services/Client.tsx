  ...
  return (
    <>
      <style>{`
        ...
        .grid-2col-start { display: grid; grid-template-columns: 1fr 1fr; gap: 60px; align-items: start; }
        .grid-3col { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1px; }
        .grid-3col-gap { display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; }
        .grid-2col-gap { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }
        .why-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 80px; align-items: center; }

        /* ── Tab bar ── */
        .tab-bar { display: flex; gap: 0; border-bottom: 1px solid ${C.stoneDk}; margin-bottom: 60px; overflow-x: auto; -webkit-overflow-scrolling: touch; scrollbar-width: none; }
        .tab-bar::-webkit-scrollbar { display: none; }
        .tab-bar-item { background: none; border: none; cursor: pointer; padding: 16px 24px; font-size: 12px; font-weight: 500; letter-spacing: 1px; text-transform: uppercase; white-space: nowrap; transition: color .2s, border-color .2s; margin-bottom: -1px; }

        /* ── Process card hover ── */
        .proc-card:hover { border-top-color: ${C.gold} !important; transform: translateY(-3px); }
        ...
        @media (max-width: 768px) {
          ...
          /* Hero service selector grid: 2 cols on mobile */
          .hero-svc-grid {
            grid-template-columns: repeat(2, 1fr) !important;
          }

          /* Service overview + process: 1 col on small mobile */
          .grid-3col,
          .grid-3col-gap {
          ...
          .cta-btns-center { flex-direction: column !important; align-items: center !important; }

          /* Stat grid stays 2-col — already fine */
          .grid-2col-gap { grid-template-columns: 1fr 1fr !important; gap: 12px !important; }

          /* Detail panel image aspect ratio less tall */
          .svc-visual { aspect-ratio: 3/2 !important; padding: 24px !important; }
        ...
        @media (max-width: 480px) {
          ...
          .grid-2col-gap { grid-template-columns: 1fr 1fr !important; }

          .hero-h1 { font-size: 30px !important; }
        }

        /* ── Overview grid responsive (already had some, unify here) ── */
        @media (max-width: 900px) {
          .svc-overview-grid { grid-template-columns: 1fr 1fr !important; }
        }
      ...
      <main>
        ...
        >
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            ...
            {/* Detail panel — 2-col collapses to 1-col via .grid-2col-start */}
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      ...
                      guarantee. If it&apos;s not right, we fix it — no
                      questions asked.
                    </div>
                  </div>
                </div>
        ...
        <section
          className="section-pad"
          style={{ background: C.navyDk, padding: "100px 5%" }}
        >
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            <div
              style={{
        ...
        <section
          className="section-pad"
          style={{ background: C.stone, padding: "100px 5%" }}
        >
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            <div
              style={{
            ...
            {/* Process grid — 3-col → 2-col → 1-col */}
            <div
              className="grid-3col-gap proc-grid"
              style={{
                display: "grid",
                gridTemplateColumns: "repeat(3,1fr)",
                gap: "20px",
        ...
        >
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            <div className="why-grid">
              ...
              {/* Stat blocks — stays 2-col on all breakpoints */}
              <div
                className="rev grid-2col-gap"
                style={{
                  display: "grid",
        ...
        >
          ...
          >
            ...
            <div
              className="rev d3 cta-btns-center"
              style={{
                display: "flex",
                gap: "14px",
                justifyContent: "center",
